...
\begin{itemize}
  ...
  \item \textcolor{red!50}{Module}, \textcolor{blue!50}{Body}, \textcolor{green!50}{Signal Declaration}, \textcolor{cyan!50}{Instantiation}, \textcolor{yellow!100}{Combinational Logic}
\end{itemize}
...
\begin{columns}
    \begin{column}{0.6\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
              \item Applies stimuli to the model under test (DUT) using testbenches.  
