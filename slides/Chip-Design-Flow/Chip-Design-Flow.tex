...
\begin{columns}
    \begin{column}{0.6\textwidth}
        ...
        \href{https://ocdcpro.github.io/educator-portal/handbook/digital_flow/}{Digital Flow}
        }
    \end{column}
...
\begin{columns}
    ...
    {\footnotesize
    \textbf{More Information on:}
    \href{https://ocdcpro.github.io/educator-portal/handbook/concepts/simulation.html}{Simulation}
    }
    \end{column}
...
\vspace{15mm}
    {\footnotesize
    \textbf{More Information on:}
    \href{https://ocdcpro.github.io/educator-portal/handbook/concepts/floorplaning.html}{Floorplanning}
    }
...
\vspace{20mm}
  ...
  \begin{column}{0.45\textwidth}
    \vspace{-9mm}
    \raggedright
    \includegraphics[width=1\linewidth]{img/detailed_routing.png}
  \end{column}
\end{columns}
\end{frame}
...
\vfill
\centering
{\Huge \bfseries Signoff \& Physical Verification}
\vfill
\end{frame}
...
\end{itemize}
\centering
\includegraphics[width=0.8\linewidth]{img/fillers.png}

\raggedright
\vspace{1mm}
    {\footnotesize
    \textbf{More Information on:}
    \href{https://ocdcpro.github.io/educator-portal/handbook/concepts/parasitic_extraction.html}{RC Extraction}
    }
...
\end{itemize}
\centering
\includegraphics[width=0.5\linewidth]{img/rc-layout.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}
  \item Uses post-layout parasitic extraction (RC) for accurate delay modeling.
  \item Verifies setup and hold constraints on all timing paths.
  \item Analyzes clock latency, skew, and uncertainty after CTS and routing.
  \item Identifies critical paths and remaining timing violations.
  \item Required for timing signoff before tapeout.
\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
\centering
...
\begin{itemize}
  \item The final GDSII is sent to the foundry for manufacturing (tapeout).
  \item Design changes are no longer possible after this point.
  \item Chip fabrication takes weeks to months, depending on the technology.
  \item The manufactured chips are returned for testing and validation.
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{From Design to Automation}
\begin{columns}
\begin{column}{0.6\textwidth}
\begin{itemize}
  \item Modern IC physical implementation is too complex to be done manually.
  \item The number of transistors and design constraints require automated flows.
  \item EDA tools enable the automation of synthesis, placement, routing, and signoff.
  \item In this course, we use a fully open-source toolchain.
  \item The next section introduces the LibreLane flow in detail.
\end{itemize}
\vspace{5mm}
    {\footnotesize
    \textbf{More Information on:}
    \href{https://ocdcpro.github.io/educator-portal/handbook/tools/}{EDA Tools}
    }
\end{column}
\begin{column}{0.4\textwidth}
\centering
\includegraphics[width=0.45\linewidth]{img/openroad.png}
\includegraphics[width=0.45\linewidth]{img/klayout.png}
\includegraphics[width=1\linewidth]{img/yosys.png}
\includegraphics[width=1\linewidth]{img/librelane.png}
\end{column}
\end{columns}
\end{frame}
